...
// Utility function to save cart items to localStorage
...
export const cartReducer = createSlice({
    ...
    reducers: {
        addToCart: (state, action: PayloadAction<CartItem>) => {
            ...
            saveCartToLocalStorage(state.cartItems); // Save to localStorage after update
        },
...
export const { addToCart, saveCoupon, removeCartItem, calculatePrice, discountApplied, saveShippingInfo, resetCart } = cartReducer.actions;
